...
class AppTranslations extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
        ...
        'en_US': {
          ...
          'altimeter': 'Altimeter',
          'altimeter_title': 'Measure Your Altitude',
          'compass': 'Compass',
          'compass_title': 'Point to Adventure',
          'my_location': 'My Location',
          'my_location_title': 'Find Your Way',
          'street_view': 'Street View',
          'street_view_title': 'Explore the Streets',
          'discovery_exploration': 'Discovery & Exploration',
          'famous_places': 'Famous Places',
          'famous_places_title': 'Famous Sites Await',
          'seven_wonders': 'Seven Wonders',
          'seven_wonders_title': 'Discover the Wonders',
        },
        // Arabic translations
        'ar_SA': {
